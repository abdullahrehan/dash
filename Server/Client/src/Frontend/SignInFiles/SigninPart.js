...
import firstSignupbtn from './AuthanticationApis'
function SigninPart(props) {
    ...
    const SetsigninErrorsUsername=(value)=>{setsigninErrorsUsername(value)}

    const SetsigninErrorsPassword=(value)=>{setsigninErrorsPassword(value)}

    const SetallFieldMandatorySigninErrror=(value)=>{setallFieldMandatorySigninErrror(value)}

    const Setsignupmessage=(value)=>{setsignupmessage(value)}

    const SetconfirmCode=(value)=>{setconfirmCode(value)}

    const SetsigninErrorsEmail=(value)=>{setsigninErrorsEmail(value)}

    const SetsigninErrorsEmailDBCheck=(value)=>{setsigninErrorsEmailDBCheck(value)}

const firstSignupbtn2=async()=>{
        // <firstSignupbtn SetsigninErrorsUsername={(data)=>SetsigninErrorsUsername(data)}/>
    firstSignupbtn(
    ...
    return (
        <div style={SignIn}  id='signin'>
            ...
            <div className="signinfoam-divno11">
                ...
                <button className='btn btn-dark foambtn2' onClick={firstSignupbtn2}>
...
//                 <firstSignupbtn 
//                 className='btn btn-dark foambtn2' 
//                 {...firstSignupbtnProps}
//                 onClick={firstSignupbtn}
//                 SetsigninErrorsUsername={(value)=>{setsigninErrorsUsername(value)}}
// SetsigninErrorsPassword={(value)=>{setsigninErrorsPassword(value)}}
// SetallFieldMandatorySigninErrror={(value)=>{setallFieldMandatorySigninErrror(value)}}
// Setsignupmessage={(value)=>{setsignupmessage(value)}}
// SetconfirmCode={(value)=>{setconfirmCode(value)}}
// SetsigninErrorsEmail={(value)=>{setsigninErrorsEmail(value)}}
// SetsigninErrorsEmailDBCheck={(value)=>{setsigninErrorsEmailDBCheck(value)}}>
